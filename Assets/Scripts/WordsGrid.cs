...
public class WordsGrid : MonoBehaviour
{
    ...
    private Vector2 GetFirstSquarePosition()
    {
        ...
        var midWidthPosition = (((currentGameData.selectedBoardData.columns - 1) * squareSize.x) / 2f) * 0.01f;
        var midWidthHeight = (((currentGameData.selectedBoardData.rows - 1) * squareSize.y) / 2f) * 0.01f;
    ...
    private void SpawnGridSquares()
    {
        ...
        {
            var squareScale = GetSquereScale(new Vector3(1.5f, 1.5f, 0.1f));
    ...
    private Vector3 GetSquereScale(Vector3 defaultScale)
    {
    ...
    private bool ShouldScaleDown(Vector3 targetScale)
    {
        ...
        var midWidthPosition = ((currentGameData.selectedBoardData.columns * squareSize.x) / 2f) * 0.01f;
        var midWidthHeight = ((currentGameData.selectedBoardData.rows * squareSize.y) / 2f) * 0.01f;
